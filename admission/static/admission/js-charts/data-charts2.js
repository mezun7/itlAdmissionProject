...
$(function () {
   ...
   $.ajax({
    ...
    //-----Olymp coming status
        var olympComingChartCanvas = $('#olympComingChart').get(0).getContext('2d')
    var olympComingData = {}
    ...
    //Create pie or douhnut chart
    // You can switch between pie and douhnut using the method below.
    new Chart(olympComingChartCanvas, {
      type: 'doughnut',
    ...
    //-----FirstTour coming status
        var firstTourComingRegisterChartCanvas = $('#firstTourComingRegisterChart').get(0).getContext('2d')
    var firstTourComingRegisterData = {}
    var firstTourComingRegisterOptions = {}
      $.ajax({

    url: "/api/get_first_tour_coming_register/",
    dataType: "json",
     async: false,
    success: function (data){
        firstTourComingRegisterData = data['data']
        firstTourComingRegisterOptions = data['options']
    }
  })

    //Create pie or douhnut chart
    // You can switch between pie and douhnut using the method below.
    new Chart(firstTourComingRegisterChartCanvas, {
      type: 'doughnut',
      data: firstTourComingRegisterData,
      options: firstTourComingRegisterOptions
    })
  })